  ...
  return (
    <>
      ...
      >
        ...
        <bold className="font-extrabold">JavaScript</bold>, and expertise in
        frameworks like{" "}
        <bold className="font-extrabold">Java, ReactJS, Python.</bold> I'm a
...
export default SectionWrapper(LazyAbout, "about");
